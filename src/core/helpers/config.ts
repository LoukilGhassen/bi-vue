...
export const pageTitleDisplay = computed(() => {
  return configStore.layoutConfig("pageTitle.display", "pageTitle.display");
});

export const asideMinimized = computed(() => {
  console.log(
    configStore.layoutConfig("aside.minimized", "aside.minimized"),
    "ahmed"
  );
  return configStore.layoutConfig("aside.minimized", "aside.minimized");
});
...
export const pageTitleDirection = computed(() => {
  return configStore.layoutConfig("pageTitle.direction", "pageTitle.direction");
});
