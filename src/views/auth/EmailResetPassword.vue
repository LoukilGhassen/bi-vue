        ...
        <el-card class="card">
          <div class="card-body p-lg-9">
            ...
            <div class="d-flex justify-content-center text-center">
              <h4 class="fw-bold" style="max-width:310px">
            ...
            <div class="d-flex flex-wrap justify-content-center align-items-baseline pt-lg-10">
              <router-link
                data-test="emailResetPasswordCancelLink"
                :to="{ name: 'sign-in' }"
                class=" fw-bolder me-6"
