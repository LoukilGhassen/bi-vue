    ...
    >
      ...
      >
        ...
        <el-table-column prop="actions" align="right" width="150">
          <template #default="scope">
            <router-link
              :data-test="`appconfigList${fieldsName[scope.$index]}EditLink_${
                appconfigList[scope.$index].id
              }`"
            ...
            <el-button
              :data-test="`appconfigList${fieldsName[scope.$index]}DeleteBtn_${
                appconfigList[scope.$index].id
              }`"
              @click="
      ...
      <div class="footer__wrapper mt-auto">
        <Pagination
          ...
          :total="appconfigPagination.total"
...
const { fetchAppConfigs, deleteAppConfig, fetchDataExcelAppConfigs } =
  useAppConfigStore();
