    ...
    <el-form :model="form" :rules="rules" ref="ruleFormRef">
      ...
      <div class="form_items">
        ...
        >
          <el-select
            v-model="form[field]"
            :data-test="`webelementjlistfilterImportData_${field}`"
          >
            <el-option
      ...
      <div class="d-flex justify-content-end">
        <el-button
          data-test="webelementjlistfilterImportDataFormCancelButton"
          @click="resetForm(ruleFormRef)"
          >Clear</el-button
        >
        <el-button
          data-test="webelementjlistfilterImportDataFormSubmitButton"
          type="primary"
...
const { error } = storeToRefs(useWebElementJListFilterStore());
const { createManyWebElementJListFilter } = useWebElementJListFilterStore();
...
const webelementjlistfilterInsertData: any = ref([]);
...
const handelUploadFile: UploadProps["onChange"] = (rawFile: any) => {
  if (rawFile) {
    ...
    reader.onload = (e) => {
      ...
      webelementjlistfilterInsertData.value = jsonData;
    };
...
const onSubmit = (formEl: InstanceType<typeof ElForm> | undefined) => {
  ...
  formEl.validate(async (valid) => {
    ...
    if (valid && !isEqual(initialState, rest)) {
      webelementjlistfilterInsertData.value = webelementjlistfilterInsertData.value.map(
        (item: any) => {
          let res: any = {};
          for (let key in rest) {
      ...
      await createManyWebElementJListFilter(
        webelementjlistfilterInsertData.value
      );
