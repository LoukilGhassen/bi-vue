    ...
    <el-form :model="form" :rules="rules" ref="ruleFormRef">
      ...
      <div class="form_items">
        ...
        >
          <el-select
            v-model="form[field]"
            :data-test="`actorrelationshipdefinitionImportData_${field}`"
          >
            <el-option
      ...
      <div class="d-flex justify-content-end">
        <el-button
          data-test="actorrelationshipdefinitionImportDataFormCancelButton"
          @click="resetForm(ruleFormRef)"
          >Clear</el-button
        >
        <el-button
          data-test="actorrelationshipdefinitionImportDataFormSubmitButton"
          type="primary"
...
const { error } = storeToRefs(useActorRelationshipDefinitionStore());
const {
  createManyActorRelationshipDefinition,
...
const actorrelationshipdefinitionInsertData: any = ref([]);
...
const handelUploadFile: UploadProps["onChange"] = (rawFile: any) => {
  if (rawFile) {
    ...
    reader.onload = (e) => {
      ...
      actorrelationshipdefinitionInsertData.value = jsonData;
    };
...
const onSubmit = (formEl: InstanceType<typeof ElForm> | undefined) => {
  ...
  formEl.validate(async (valid) => {
    ...
    if (valid && !isEqual(initialState, rest)) {
      actorrelationshipdefinitionInsertData.value = actorrelationshipdefinitionInsertData.value.map(
        (item: any) => {
          let res: any = {};
          for (let key in rest) {
      ...
      await createManyActorRelationshipDefinition(
        actorrelationshipdefinitionInsertData.value
      );
